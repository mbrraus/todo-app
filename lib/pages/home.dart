    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              StreamBuilder<List<Todo>>(stream: todoController.streamController.stream, builder: (context,snapshot) { //actively listening
      ...
      floatingActionButton: Padding(
        ...
        child: FloatingActionButton(
          ...
          backgroundColor: wheat.withOpacity(0.3), // Arka plan rengi saydamlıkla ayarlandı
          child: const Text(
            '+',
            style: TextStyle(
              fontSize: 35,
